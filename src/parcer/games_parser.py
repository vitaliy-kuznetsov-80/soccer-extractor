...
class GamesParser:
    ...
    @staticmethod
    def _parce_game(excel_row_index, row: WebElement, pp: ParamsParser):
        """Парсинг игры"""
    ...
    def _write_left_header(self, dto: _LeftHeaderDto):
        ...
        self.__em.write(dto.excel_row_index, 1, date_game_report)
        self.__em.write(dto.excel_row_index, 2, weekday)
        self.__em.write(dto.excel_row_index, 3, time_game)
        self.__em.write(dto.excel_row_index, 4, game_name)
        self.__em.write(dto.excel_row_index, 5, team1)
        self.__em.write(dto.excel_row_index, 6, team2)
